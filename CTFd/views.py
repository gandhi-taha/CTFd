...
def setup():
    ...
    <div class="col-md-6 offset-md-3">
        ...
        <br>
        <h5><small>Organized in order to raise awerness over the topics in cybersecurity with competition that is open to everyone, regardless of whether they are a security enthusiast or an expert, are free to showcase their abilities at this event and engage the cybersecurity domain</small></h5>
<h5><small>Points to pay attention</small></h5>
<h5><small>• Competition format</small></h5>
<p><small>Every round is intended to be an individual Capture The Flag (CTF) event, played in jeopardy-style fashion. The CTF platform will always be available for all players and if new one can registration here. Each round will have its own challenge set, scoreboard, and winner. During each round, only the challenges belonging to that round will be visible to players and will give them points to determine the round scoreboard. During the time in between rounds, challenges from past rounds will also be visible and accessible to the players, giving them the chance to play even when a round is over.</small></p>
<h5><small>• Fair play</small></h5>
<p><small>Attacking other participants or the contest infrastructure is prohibited. Targets are clearly stated in the challenge descriptions. This also includes social engineering and all the actions aimed to gain access to other player's accounts.
    ...
    If any bug or flaw is found in the infrastructure platform, players are kindly asked to report it at <a href="mailto:taha.gandhi@clearstream.com">Taha Gandhi</a>. Reports will be awarded with a special mention published on the platform itself.</small></p>
<h5><small>• Scoring</small></h5>
<p><small>After the end of a round, its scoreboard will be published with a permanent link in the home page of the platform.</small></p>
